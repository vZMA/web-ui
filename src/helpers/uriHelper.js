...
export const vatsimAuthRedirectUrl = `${getAuthEndpoint()}/oauth/authorize?client_id=${getClientId()}
&redirect_uri=${getRedirectUri()}&response_type=code&scope=vatsim_details+full_name+email`;
  ...
  function getRedirectUri()  {
    //  return "http://dev.zmaartcc.net/login/verify";
      return "https://zmaartcc.net/login/verify";
