				...
				KMIA: {
					...
					getLanding: function() {
						if(this.parsedMetar.wind.speedKt < 5) {
							if(this.parsedMetar.time.hour >= 6 && this.parsedMetar.time.hour <= 23) {
								return this.configs.landing.ED;
							} else {
								return this.configs.landing.EN;
							}
						} else {
							if(this.parsedMetar.wind.direction > 180 && this.parsedMetar.wind.direction <=359) {
								//west ops
								if(this.parsedMetar.time.hour >= 6 && this.parsedMetar.time.hour <= 23) {
				...
				KTPA: {
					...
					getLanding: function() {
						if(this.parsedMetar.wind.speedKt < 5) {
							...
							if(this.parsedMetar.wind.direction > 90 && this.parsedMetar.wind.direction <= 270) {
