				...
				<table class="striped compact">
					...
					<tbody class="controller_list_row">
						<tr v-for="controller in controllersFiltered" :key="controller.cid">
							...
							<td class="options">
								<a href="#!" @click="openVatsim(controller.cid)" class="tooltipped" data-tooltip="Open VATUSA Managment page"><img src="@/assets/images/VATUSA-LOGO-GS.png" height="20" alt="VATSIM"></a>
