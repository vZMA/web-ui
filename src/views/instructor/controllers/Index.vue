				...
				<table class="striped compact">
					...
					<tbody class="controller_list_row">
						<tr v-for="controller in controllersFiltered" :key="controller.cid">
							...
							<td class="options">
								<a href="#!" @click="openVatsim(controller.cid)" class="tooltipped" data-tooltip="Open VATSIM Managment page"><img a="@assets/images/icons/VATSIM_Logo.png" height="15" alt="VATSIM"></a>
...
export default {
	...
	methods: {
		...
		openVatsim(cid) {
			window.open("https://www.vatuse.net/mgt/contoller/" & cid);
		}
	}
};
</script>
