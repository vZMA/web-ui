		...
		<div class="card-content">
			...
			<p>
				...
				<ul>
					...
					<li>• Must be at least 60 days since you most recently joined any other VATUSA ARTCC's visiting roster.</li>
			...
			<div v-else>
				...
				<div v-if="!user.data.isMem">
					<div class="row row_no_margin" v-if="user.data">
						...
						<div class="input-field col s12">
							<label for="reason">Why would you like to visit ZMA?</label>
				...
				<div v-else>
					<p>You cannot apply to become a visitor since you're already a member of ZMA.</p>
				</div>
			</div>
		</div>
	</div>
