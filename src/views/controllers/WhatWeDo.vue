<template>
    ...
    <div class="card">
		<div class="card-content">
            ...
            <p>Today, I am a real world instrument-rated commercial pilot working toward a job with the airlines, I can say with 100% certainty that participating on VATSIM was one of the best choices I made to support my real-world pilot training:</p>
            
            <ul class="browser-default">
                <li>I gained an abundance of aviation knowledge that I would not have learned from my flight school, or even by flying many hours in a real airplane because there’s a chance I would not be exposed to the same scenarios.
                </li>
                <li>I gained a deep understanding of how the National Airspace System actually functions, and I know what is happening “on the other side of the mic.” 
                </li>
                <li>I am a safer and better pilot because of this knowledge and context. 
                </li>
                <li>I received compliments from my real-world aviation instructors who were perplexed by the amount of aviation knowledge I obtained and my expertise on various topics. 
                </li>
                <li>I was able to fly many real-world cross-country flights, into some of the busiest airspace in the United States, with ease and confidence the entire time because I know exactly what’s happening around me. 
                </li>
                <li>I have put my full faith into the knowledge I’ve gained over the years (a significant portion of which came from participation in the VATSIM community) and it has never failed me. 
                </li>
            </ul>
